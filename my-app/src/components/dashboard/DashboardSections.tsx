...
// Async server components so the Dashboard page itself only awaits
// searchParams: a ?range= change re-streams these under their own Suspense
// instead of blocking the whole page on five backend calls.

export async function DashboardTop() {
  const { asOf, period, headlineStats } = await getDashboard();
...
export async function DashboardCards() {
  ...
  const { totalUnpaid, unpaidInvoices, projectStats } = dashboard;
